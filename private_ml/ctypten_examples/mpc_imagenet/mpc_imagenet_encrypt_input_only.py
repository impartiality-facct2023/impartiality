...
from private_ml.ctypten_examples.meters import AccuracyMeter
...
"""
RuntimeError: Cannot input CrypTensors into unencrypted model.
...
def run_experiment(
    ...
    logging.info(
        "Accuracy on all %d samples: %f" % (len(dataset), meter.value()[1]))
