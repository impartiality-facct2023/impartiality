...
from private_ml.ctypten_examples.multiprocess_launcher import \
    MultiProcessLauncher
from private_ml.ctypten_examples.mpc_imagenet.mpc_imagenet import run_experiment

# from private_ml.ctypten_examples.mpc_imagenet.mpc_imagenet_encrypt_input_only import \
#     run_experiment
...
parser = argparse.ArgumentParser(
    description="Encrypted inference of vision models")
parser.add_argument(
    "--world_size",
    type=int,
    default=2,
...
parser.add_argument(
    "--imagenet_folder",
    default=f'/home/{user}/data/imagenet',
    type=str,
...
def _run_experiment(args):
    ...
    run_experiment(
        args.model_from_cost_to_timing,
