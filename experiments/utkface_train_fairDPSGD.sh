...
file_name='utkface_dpsgd_inprocessing_public.csv'
fairness_factor=(15.0)
budget=(4)
...
do
    ...
    do
        ...
        --loss_type 'CEWithDemParityLossPub' \
        --mode 'random' \
        ...
        --batch_size 80 \
        --file_name ${file_name} \
        --inprocessing_fairness 1 \
        --inprocessing_fairness_penalty_scaler ${fairness_factor[$ft]}
    done
done
